...
public class CourseRepository {
    ...
    public Optional<Course> save(String courseName, String courseDescription, Long teacherId) {
        ...
        if(DataHolder.courses.stream().anyMatch(crs -> crs.getName().equals(courseName)))
            return DataHolder.courses.stream().filter(crs -> crs.getName().equals(courseName)).findFirst();
